...
-- Sunset Sailing in the French Riviera itinerary (experience_id = e1a2b3c4-d5e6-7777-8888-999900000001)
('it1a2b3c4-d5e6-7777-8888-999900000001', (SELECT id FROM experiences WHERE title = 'Sunset Sailing in the French Riviera'), 1, '19:00', 30, 'Welcome Aboard & Safety Briefing', 'Meet your crew at Port de Nice. Enjoy a welcome drink and a brief safety orientation before departure.', 'Port de Nice', ARRAY['Boarding', 'Safety Briefing', 'Welcome Drink']),
('it1a2b3c4-d5e6-7777-8888-999900000002', (SELECT id FROM experiences WHERE title = 'Sunset Sailing in the French Riviera'), 2, '19:30', 60, 'Coastal Cruise & Appetizers', 'Sail along the stunning coastline towards Cap Ferrat. Enjoy gourmet appetizers and local wines as the sun begins to dip.', 'Cap Ferrat Coastline', ARRAY['Scenic Sailing', 'Appetizers & Wine']),
('it1a2b3c4-d5e6-7777-8888-999900000003', (SELECT id FROM experiences WHERE title = 'Sunset Sailing in the French Riviera'), 3, '20:30', 45, 'Sunset Viewing & Photography', 'Anchor in a prime spot to witness the spectacular Mediterranean sunset. Perfect opportunity for photos.', 'Baie des Anges', ARRAY['Sunset Viewing', 'Photography']),
('it1a2b3c4-d5e6-7777-8888-999900000004', (SELECT id FROM experiences WHERE title = 'Sunset Sailing in the French Riviera'), 4, '21:15', 45, 'Return to Port', 'Leisurely sail back to Port de Nice under the stars, reflecting on a beautiful evening.', 'Port de Nice', ARRAY['Night Sailing', 'Relaxation']),

-- Beginner Surf Lessons at Bondi Beach itinerary (experience_id = e1a2b3c4-d5e6-7777-8888-999900000002)
('it1a2b3c4-d5e6-7777-8888-999900000005', (SELECT id FROM experiences WHERE title = 'Beginner Surf Lessons at Bondi Beach'), 1, '10:00', 15, 'Meet & Greet, Gear Up', 'Meet your instructor at the surf school. Get fitted for wetsuits and pick up your surfboard.', 'Bondi Beach Surf School', ARRAY['Check-in', 'Gear Distribution']),
('it1a2b3c4-d5e6-7777-8888-999900000006', (SELECT id FROM experiences WHERE title = 'Beginner Surf Lessons at Bondi Beach'), 2, '10:15', 30, 'Beach Safety & Basics', 'Learn about ocean safety, currents, and basic paddling and pop-up techniques on the sand.', 'Bondi Beach', ARRAY['Safety Briefing', 'Dry Land Practice']),
('it1a2b3c4-d5e6-7777-8888-999900000007', (SELECT id FROM experiences WHERE title = 'Beginner Surf Lessons at Bondi Beach'), 3, '10:45', 60, 'Into the Waves!', 'Head into the water with your instructor. Practice catching waves and standing up with personalized guidance.', 'Bondi Beach', ARRAY['Paddling', 'Wave Catching', 'Standing Up']),
('it1a2b3c4-d5e6-7777-8888-999900000008', (SELECT id FROM experiences WHERE title = 'Beginner Surf Lessons at Bondi Beach'), 4, '11:45', 15, 'Wrap-up & Debrief', 'Return to shore, debrief with your instructor, and return equipment. Get tips for continuing your surf journey!', 'Bondi Beach Surf School', ARRAY['Debrief', 'Equipment Return']);

INSERT INTO schema_migrations (version) VALUES ('08-seed-itineraries-' || TO_CHAR(CURRENT_TIMESTAMP, 'YYYYMMDDHH24MISSMS'))
